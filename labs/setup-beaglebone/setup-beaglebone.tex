\subchapter{Training setup - BeagleBone}{Setup files and directories used in practical labs}
...
Lab data are now available in an \code{labs} directory in your home
