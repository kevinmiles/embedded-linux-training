...
monitor. Here are special instructions to format an SD card
...
\emph{NOTE: If you have problems booting the SD card on the Beaglebone, try to format the first partition as FAT16 (line 68 of mkcard.sh) }
